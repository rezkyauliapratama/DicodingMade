package id.innovation.libcore.errorhandler
...
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_BAD_REQUEST
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_FORBIDDEN
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_NOT_FOUND
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_REDIRECT
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_SERVER_ERROR
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_UNAUTHORIZED
import id.innovation.libnetwork.common.NetworkException.Companion.CODE_UNPROCESSABLE
import id.innovation.libnetwork.common.RedirectException
 ...
 *
 */
class ErrorTransformer<T> @Inject constructor(
    private val moshi: Moshi,
    private val errorBody: NetworkErrorInterface
    ...
    /**
     * @author Rezky Aulia Pratama
     * This method is to handle the Error that cause by HttpException.
     * It'll translate the HttpException error into the generic error
    ...
    private fun networkException(httpException: HttpException): Exception {
        ...
        return httpExceptionGenerate(httpException, message)
    }

    private fun httpExceptionGenerate(httpException: HttpException, message: String?): Exception {
